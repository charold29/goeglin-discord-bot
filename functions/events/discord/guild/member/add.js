...
registerFont(aristaFont, {family: 'Arista'})
...
// 3. Goeglin
const goeglinImage = await loadImage('https://i.postimg.cc/8zm5gZ25/q.png');
const sizeGoeglin = [320,306]
...
// Goeglin
ctx.drawImage(goeglinImage, 400, 60, ...sizeGoeglin)
